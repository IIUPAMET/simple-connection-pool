...
public class FiliConnection implements Connection {

  private final Connection connection;
  private final Deque<Statement> statements = new LinkedList<>();
  private final FiliDataSource connectionPool;

  public FiliConnection(Connection connection, FiliDataSource filiDataSource) {
    this.connection = connection;
    this.connectionPool = filiDataSource;
  }
  ...
  public CallableStatement prepareCall(String s) throws SQLException {
    CallableStatement statement = connection.prepareCall(s);
    statements.add(statement);
    return statement;
  }
